...
public class ProverbProtocol {
    ...
    public ProverbProtocol(){ playerNumber++;}
    ...
    public String processInput(String theInput){
        ...
        switch (state){
            ...
            case MAYBE_KEEP_PLAYING:
                if(theInput.equalsIgnoreCase("y"))return processClue();
                return processExit();
        }
    }
    ...
    private String processGuess(String theInput){
        if(theInput.equalsIgnoreCase(ANSWER_LIST.get(currentClue))){
            ...
            return "Excellent!" + CLUE_LIST.get(currentClue)+ ""+ANSWER_LIST.get(currentClue)+"|" + "Keep playing? (y/n)";
        }else{
